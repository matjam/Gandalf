...
Decide early whether this folder is shared between machines. If it is not, do not link
to session notes from durable notes — those links will resolve on one machine and
dangle everywhere else.
